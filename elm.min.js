	...
	switch (model) {
		...
		case 2:
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Failed loading website')
					]));
		default:
			return A2(
				elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('The Thaumatorium')
									])),
								A2(
								elm$html$Html$p,
								_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('We are based in the Netherlands. We like to take an unnormal take on things: Take a look at what the masses are doing, learning from them by NOT doing that and finding out where the good shit is at!'),
								elm$html$Html$text('That doesn\'t mean that popular = bad. We just hate JavaScript and its ecology. Fuck JavaScript.')
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {al: fragment, ao: host, av: path, ax: port_, aA: protocol, aB: query};
	});
...
var elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			a2: function (_n0) {
				return _Utils_Tuple2(impl.a2, elm$core$Platform$Cmd$none);
			},
			bj: function (_n1) {
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{a2: author$project$Main$init, bn: author$project$Main$update, bp: author$project$Main$view});
